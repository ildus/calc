{**
  ...
  Адаптация к Delphi 7 - Сергей Гурин
...
{$ENDIF}
  ...
  // Этот класс вынесен из секции implementation и сделан доступным для
  // приложений, использующих многопотоковость
  ...
  // Этот класс и его производные вынесены из секции implementation и сделаны
  // доступным для приложения в качестве специфических распределителей памяти
...
{ TDeCALCriticalSection }

constructor TDeCALCriticalSection.Create;
begin
  // We're going to define our own, because not everybody has the SyncObjs unit.
  inherited Create;
